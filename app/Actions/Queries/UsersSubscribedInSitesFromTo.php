...
// طلاب اشتركو فى دبلومات معينة من الى
class UsersSubscribedInSitesFromTo
{
    ...
    public function collectQuery()
    {
        ...
        return DB::Table('members')
            ...
            ->whereIn('site_subscriptions.site_id', $this->site_id)
            ->where('site_subscriptions.created_at', '>=', date('Y-m-d 00:00:00', strtotime($this->from_date)) )
            ->where('site_subscriptions.created_at', '<=', date('Y-m-d 23:59:59', strtotime($this->to_date)) )
