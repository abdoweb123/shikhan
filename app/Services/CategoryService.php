...
class CategoryService
{
  use Cachement;
    ...
    public function queryAll( $params = [], $language = null)
    {
        ...
        $data = DB::Table('categories')
                    ...
                    ->select('categories.id','categories.title_general','categories.parent_id','category_info.title','category_info.alias','category_info.image',
                      'type','user_type_id','is_active','read_only')
    ...
    // return Array services as tree
    public function getServicesTreeRoot($language = null)
    {
        ...
        $data = UtilHelper::buildTreeRoot( $data );
        // $this->cacheForever($cacheName,$data);
    ...
    public function getCategoriesTreeFor($userTypeId,$language = null)
    {
        ...
        $data = $this->getAll($language)->filter(function ($category) use($userTypeId){
            return $category->user_type_id == $userTypeId ;
        });
    ...
    public function transportCategoriesIds()
    {
      return [6,12,13];
    }
