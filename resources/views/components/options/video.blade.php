...
<div class="embed-responsiveembed-responsive-16by9" style="text-align: center;">
      ...
      @elseif ((strpos($myvalue, 'youtube') !== false)&&((strpos($myvalue, 'embed/') !== false)&&(strpos($myvalue, 'ifram') == false)&&(strpos($myvalue, 'object') == false)))
          <!--2-->
           <iframe id="video_iframe" style="height: 420px;width: 100%;" class="embed-responsive-item" src="{{$myvalue}}"></iframe>
      @elseif ((strpos($myvalue, 'youtube') !== false)&&((strpos($myvalue, 'embed/') == false)&&(strpos($myvalue, 'ifram') == false)&&(strpos($myvalue, 'object') == false)))
          <?php
            $raw_link = $item->value;
          ...
          <!--3-->
          <iframe id="video_iframe" style="height: 420px;width: 100%;" class="embed-responsive-item" src="{{$src}}"></iframe>
      @elseif(strpos($myvalue, 'drive.google') !== false)
        @php $link = str_replace('view?usp=sharing','preview',$myvalue); @endphp
        @php $link = str_replace('view?usp=share_link','preview',$link); @endphp
        @php $link = str_replace('view?usp=drive_link','preview',$link); @endphp
      ...
      @elseif(strpos($myvalue, 'object') !== false)
        ...
        $youtube_id = explode('?',$arr[1]);
         ...
         ?>
         <!--4-->
        <iframe id="video_iframe" style="height: 420px;width: 100%;" class="embed-responsive-item" src="https://www.youtube.com/embed/{{$src}}"></iframe>
      @elseif (strpos($myvalue, 'https://') !== false)
            <!--6-->
             <iframe id="video_iframe" style="width: 100%;height: 420px;" class="embed-responsive-item" src="{{$myvalue}}"></iframe>
      @endif
