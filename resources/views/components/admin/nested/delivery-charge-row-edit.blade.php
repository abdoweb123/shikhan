  ...
  <div class="table-responsive">
    <table class="table">
      ...
      <tbody>
        ...
        <form id="frm_category_status" name="frm_category_status" action="{{ route('admin.deliverycharges.update',['id' => $data->id ]) }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
        ...
        <tr>
          ...
          <td>
              ...
              value="{{ old('d_from', $data->d_from ) }}" maxlength="3" name="d_from" placeholder="">
          ...
          <td>
              ...
              value="{{ old('d_to', $data->d_to ) }}" maxlength="3" name="d_to" placeholder="">
              @if ($errors->has('d_to'))
          ...
          <td>
              ...
              value="{{ old('charge', $data->charge ) }}" maxlength="5" name="charge" placeholder="">
