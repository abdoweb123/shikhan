        ...
        <div class="kt-portlet__head">
          <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
              <div class="row">
                {{ __('words.edit') }} &nbsp; {{ $data->name }}  &nbsp;  {{ request()->query('language') }}
      ...
      <div class="form-group row">
        ...
        <div class=" col-lg-8 col-md-9 col-sm-12">
          <x-inputs.ckeditor name="html"
            ...
            data="{!!  file_exists('storage/app/public/'.($translation->description ?? 'nofile')) == true ? file_get_contents('storage/app/public/'.($translation->description ?? '')) : '' !!}" />
          <!-- <span class="form-text text-muted">Please enter your full name</span> -->
