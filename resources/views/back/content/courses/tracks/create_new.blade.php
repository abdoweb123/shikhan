                ...
                <div class="col-sm-4">
                    ...
                    @foreach($lessons as $lesson)
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{++$i}}" class="form-control" name="lesson_ids[{{$loop->index}}][sort]"/>
                        </div>
                    @endforeach
                </div>
                <div class="col-sm-4">
                    @foreach($tests as $test)
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="{{++$i}}" class="form-control" name="test_ids[{{$loop->index}}][sort]"/>
                        </div>
                    @endforeach
                </div>
            </div>
