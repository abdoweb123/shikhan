          ...
          <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                  ...
                  <div class=" col-lg-9 col-md-9 col-sm-12">
                      <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" required maxlength="150"
              ...
              <div class="form-group row">
                  ...
                  <div class=" col-lg-9 col-md-9 col-sm-12">
                      <input type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" required maxlength="150"
            ...
            <div class="form-group row">
                ...
                <div class=" col-lg-8 col-md-9 col-sm-12">
                  <textarea  class="form-control {{ $errors->has('qualification') ? ' is-invalid' : '' }}"
                    name="qualification" placeholder="">{{ old('qualification') }}</textarea>
                  <!-- <span class="form-text text-muted">Please enter your full name</span> -->
            ...
            <div class="form-group row">
                ...
                <div class=" col-lg-8 col-md-9 col-sm-12">
                  <textarea  class="form-control {{ $errors->has('specialization') ? ' is-invalid' : '' }}"
                    name="specialization" placeholder="">{{ old('specialization') }}</textarea>
                  <!-- <span class="form-text text-muted">Please enter your full name</span> -->
            ...
            <div class="form-group row">
                ...
                <div class=" col-lg-8 col-md-9 col-sm-12">
                  <textarea  class="form-control {{ $errors->has('position') ? ' is-invalid' : '' }}"
                    name="position" placeholder="">{{ old('specialization') }}</textarea>
                  <!-- <span class="form-text text-muted">Please enter your full name</span> -->
