            ...
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <h2> {{ $fields->frequency.' | '.__('core.edit') }} </h2>
                        <a class="btn btn-success pull-right" href="{{ route('dashboard.sender.create',['site' => $site->alias,'course' => $fields->course_id]) }}"> @lang('core.add') </a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        ...
                        @include('back.includes.breadcrumb',['routes' => [
                            ...
                            ['slug' => route('dashboard.sender.index',['site' => $site->alias,'course' => $course_id]),'name' => $course->name.' | '.__('meta.title.test_results')],
                            ['name' => $fields->frequency.' | '.__('core.edit')]]
                        ])
                        <hr>
                        ...
                        {!! Form::model($fields,['method' => 'PUT','route' => ['dashboard.sender.update',$site->alias,$fields->course_id,$fields->id],'class'=>'form-horizontal form-label-left']) !!}
                            <div class="form-group{{ $errors->has('frequency') ? ' has-error' : '' }}">
                                ...
                                <div class=" col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ Request::old('frequency') ?: ''.$fields->frequency.'' }}" id="frequency" name="frequency" class="form-control col-md-7 col-xs-12">
...
# *  *  *  *  * user-name  command to be executed
                            ...
                            <div class="form-group{{ $errors->has('count') ? ' has-error' : '' }}">
                                ...
                                <div class=" col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ Request::old('count') ?: ''.$fields->count.'' }}" id="count" name="count" class="form-control col-md-7 col-xs-12">
                                    @if ($errors->has('count'))
                            ...
                            <div class="form-group{{ $errors->has('languages') ? ' has-error' : '' }}">
                                ...
                                <div class=" col-md-6 col-sm-6 col-xs-12">
                                    <select name="languages[]" class=" form-control col-md-6 col-sm-6 col-xs-12" multiple>
                                        ...
                                        @else
                                            @foreach($languages as $lang => $name)
                                                <option @if(in_array($lang,$fields->languages)) selected value="{{ $lang }}" @else value="{{ $lang }}" @endif > {{ $name }} </option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
