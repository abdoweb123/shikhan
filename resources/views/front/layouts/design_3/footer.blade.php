  <!--Start Footer Area -->
    ...
    @php $whatsNumber = ''; @endphp
    @if (app()->getlocale() == 'sw')
      @php $whatsNumber = '+254790305852'; @endphp
    @endif
    @if (app()->getlocale() == 'ha')
      @php $whatsNumber = '+01503213993'; @endphp
    @endif
    ...
    --}}
      ...
      <footer class="footer-area" style=" padding-top: 0px !important;">
            <div class="footer-bottom-area m-0 p-0  prim-back-color">
                <div class="row" style="width: 100%;">
                    <div class="col-12 col-md-6 mt-3">
                        <ul>
                            @if(LaravelLocalization::getCurrentLocaleDirection() == 'rtl')
                                ...
                                <i class='bx bx-copyright'></i>2023  <a href="{{ url('/')}}" target="_blank">{{ __('core.app_name') }}</a> - {{ __('core.all_rights_reserved')}}</div>
                            @else
                                <li>
                    ...
                    <div class="col-12 col-md-6 single-footer-widget" style="text-align: center;">
