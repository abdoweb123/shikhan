    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center" style="text-align: center;color: white;">
          <div class="col-12 mt-5" style="">
              ...
              <span style="color: white !important;">{{ __('core.valid_quiz_count' , ['degree'=> $courseTestResult->degree]) }}</span>
              <h1 style="color: white !important;" style="font-size: 60px;direction: rtl;">(%{{ $courseTestResult->degree  }}){{__('words.rate_is')}}: {{ __('trans.rate.'.$courseTestResult->rate )  }}</h1>
              ...
              <div class="col-md-6" style="padding-bottom: 20px;">
                <div class="card bg-light" style="border: 1px solid #ead9a8;box-shadow: 0 3px 20px rgba(0, 0, 0, 0.15);padding: 5px 5px;border-radius: 14px;">
                  <div class="card-body" style="@if (LaravelLocalization::getCurrentLocaleDirection() =='rtl') text-align: right; @endif ">
                      <h4 class="card-title text-dark" style="font-size: 17px;line-height: 2;user-select: none;"> {{$loop->iteration}} - {{ $answers->first()->question_title }} </h4>
                            ...
                            <div style="color: black;">
                              <div style="padding: 3px;">
                                ...
                                @if( $answer->course_answer_id == $answer->user_answer_id && $correctAnswer != $answer->user_answer_id)
                                  <i class="fas fa-times" style="color: red;font-size: 25px;"></i>
                                @endif
                              </div>
                            </div>
                          @endforeach
