        ...
        <div class="row  align-items-center">
            <div class="col-12" >
                <div class="hero-content text-center row">
                    <div class="col-md-12 justify-content-center" style="text-align: center;display: flex;padding-top: 10px;">
                    ...
                    <div class="col-md-12 justify-content-center" style="text-align: center;display: flex;padding-top: 5px;padding-bottom: 5px !important;">
                      <div class="col-md-2"><span style="margin: 0px 0px 0px 23px;display: block;font-size: 17px;font-weight: bold;color: #fff3cf;padding: 12px 32px;background-color: white;border-radius: 4px;color: brown;border: 1px solid #b5b5b5;">{{ $siteCoursesCount }} {{ __('trans.course') }}</span></div>
