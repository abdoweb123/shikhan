...
<!-- Large modal -->
<button type="button"
  style="border: 1px solid #a5d2be;background-color: white;border-radius: 50px;padding: 12px 55px;"
  class="btn" data-toggle="modal" data-target="#support_model_{{ $modalId }}">
  <span class="sec-color">{{ $title }}</span>
  <i class="fas fa-play-circle sec-color" aria-hidden="true" style="font-size: 30px;"></i>
</button>
