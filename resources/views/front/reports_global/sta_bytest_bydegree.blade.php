...
<div class="container-fluid" style="background-color: #daeee9;text-align: right;">
  <div class="container" style="padding: 20px 0px;">
    ...
    <div style="text-align: right;">
      <br>
    الطلاب مع عدد اختبارات كل طالب -
      (اختبار واحد لكل دورة وهو الاعلى درجة) -
      مع متوسط درجات الطالب لكل اختباراته -
      مع عدد الدورات المشترك فيها -
      مع عدد الدورات الفعالة المشترك فيها -
      مرتبين بالدرجة الإجمالية<br><br>
    </div>
                          ...
                          <tbody>
                            @foreach($report as $item)
                              <tr>
                                ...
                                <td>{{ $item->all_subscribtions_count }}</td>
...
<script>
  // datatable settings
  dt1_display_search_input_columns_values = [1,2,3];
