...
<div class="container-fluid" style="background-color: #daeee9;text-align: right;">
  <div class="container" style="padding: 20px 0px;">
    ...
    <div style="text-align: right;">
      <br>
    الجوائز الثانية - كل من اكمل دبلوم مرتبين بمتوسط الدرجة على مستوى الدبلوم<br><br>
    </div>

    <span style="font-weight: bold;">عدد الدورات الفعالة فى كل دبلوم</span><br>
    @foreach ($countActiveCoursesInEachSite as $activeCourse)
      {{ $activeCourse->title }} : {{ $activeCourse->count_active_courses }}<br>
    @endforeach
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                  <thead>
                    <tr>
                      ...
                      <th>الطالب</th>
                      <th>الدبلوم</th>
                      <th>عدد الاختبارات فى الدبلوم</th>
                      <th>متوسط الدرجات</th>
                      <th>التليفون</th>
                      <th>البريد</th>
                      <th>الواتس</th>
