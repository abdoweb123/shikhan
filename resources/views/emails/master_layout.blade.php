...
<html xmlns="http://www.w3.org/1999/xhtml" dir="{{ get_dir(config('localization.'.$settings->locale.'.script')) }}" lang="{{ $settings->locale }}" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
