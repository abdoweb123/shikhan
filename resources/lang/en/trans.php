...
"diplomas_next"=>"Upcoming Diplomas",
"subscribe"=>"Subscribe",
"subscribe_in_diploma"=>"Subscribe in Diploma",
...
"active"=>"Active",
"duration"=>"Duration",
"diplome_successed_users"=>"Names of the graduates of",
"student"=>"Students",
"until_today"=>"until the date",
"teachers"=>"IsTeacher",
"previous_tests_results"=>"You tested this course before",
"video"=>"Video",
"course_start_at"=>"Course starts at",
"live_course"=>"Live",
"start_course"=>"Ready to Study",
"start_at" => "start_at",
...
your mail sent ,
We will send you all new via e-mail",
...
"why_us_text"=>"The idea of ​​establishing the academy emerged as a result of the existence of a state of scientific vacuum in the Arab countries,
 and to confront the false ideas that work to shake people's beliefs,
 there was an urgent need to simplify Islamic science and make it accessible to everyone through modern means and technologies.      • Graduating students with a sufficient degree of knowledge and mastery scientifically and skillfully in Sharia and auxiliary sciences.      • Developing the skills and building the scientific faculties that science students need.",
"how_to_start"=>"How to start",
"select_diploma"=>"Select diploma",
"select_diploma_brief"=>"Enter the diplomas first,
 and then choose the desired course",
"show_course_details"=>"Show cource details",
"show_course_details_brief"=>"When selecting the course to be studied from the diploma,
 the course content (video,
 audio,
 and reference) is displayed.",
"register_subscripe"=>"Registration and subscription",
"register_subscripe_brief"=>"Click on (Register as a new student,
...
'please_enter_id_image' => 'Please enter the national id',
];
